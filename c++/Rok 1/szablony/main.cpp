   ...
   tablica<T_osoba> wektor;      
    ...
    while( !koniec){
           ...
           try{
               ...
               catch( tablica<T_osoba>::brak_pamieci){
                      cerr << " Nie moge zaalokowac pamieci!" << endl; 
                      pause();
                      }         
               catch( tablica<T_osoba>::zly_rozmiar){
                      cerr << " Podany przez Ciebie index jest poza tablica! " << endl; 
                      pause();
                      }
               catch( ...){
                      cout << " Cos jest nie tak, ale nie mam pojecia co." <<endl;
                      pause();
                      }
